...
const EventRegistrationListing = () => {
  ...
  // const downloadCertificatePDF = async (event) => {
  //   try {
  //     setDownloadingCert(event._id);
  //     setCertEvent(event);
              ...
              return (
                ...
                >
                  <div className="relative w-full h-48">
                    ...
                    {/* {canDownloadCertificate(event) && (
                      <button
                        onClick={() => downloadCertificatePDF(event)}
                        disabled={downloadingCert === event._id}
                        className="absolute top-3 right-3 bg-white/90 hover:bg-white text-primary-600 shadow-md p-2 rounded-full transition disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Download Certificate"
                      >
